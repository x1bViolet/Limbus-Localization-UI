...
using static LCLocalizationInterface.Kaestarlyn.@PostInfo.FullStopDividers;
using static LCLocalizationInterface.Kaestarlyn.@Tags;
...
#pragma warning restore CS8618
            ...
            (
                ...
                else
                {
                    ...
                    List<StableTextConstruction> @Segments = [.. RichText.Cut("\r").Split(['\xFFFE', '\xFFFF'], StringSplitOptions.RemoveEmptyEntries).Select(RegularText => new StableTextConstruction(RegularText))];
