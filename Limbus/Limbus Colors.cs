...
{
    public ref struct @ColorInfo
    {
        public static readonly Dictionary<string, string> Affinities_GameColors = new()
        {
            ["Wrath"   ] = "#fe0101",
            ["Lust"    ] = "#fe6f01",
            ["Sloth"   ] = "#edc427",
        ...
        public static readonly Dictionary<string, string> Affinities_InfoPreviewColors = new()
        {
            ["Wrath"   ] = "#ff0000",
            ["Lust"    ] = "#cc5200",
            ["Sloth"   ] = "#c9a022",
        ...
        public static readonly Dictionary<string, string> SinnerColors = new()
        {
            ["Yi Sang"    ] = "#d4e1e8",
            ["Faust"      ] = "#ffb1b4",
            ["Don Quixote"] = "#ffef23",
